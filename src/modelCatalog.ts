...
export const MODEL_CATALOG: Record<RouterModel, ModelCatalogEntry> = {
  ...
  'deepseek-v4-flash': {
    ...
    description: 'High-speed reasoning & economics tier — $0.28/M output',
    color: '#0066FF',
    icon: '⚡',
  },
  ...
  'deepseek-v4-pro': {
    ...
    description: 'Balanced coding & deep reasoning tier — $2.19/M output',
    color: '#0044CC',
    icon: '🧠',
  },
  'gpt-5.6-luna': {
    ...
    description: 'Fast cloud conversational model — $1.40/M output',
    color: '#10A37F',
    icon: '🌙',
  },
  'gpt-5.6-terra': {
    ...
    description: 'Strong balanced reasoning model — $5.00/M output',
    color: '#0E8065',
    icon: '🌍',
  },
  'gpt-5.6-sol': {
    ...
    description: 'Max tier frontier reasoning model — $14.00/M output',
    color: '#D97706',
    icon: '☀️',
  },
  'claude-sonnet-5': {
    ...
    shortName: 'Sonnet 5',
    description: 'Premier coding & analysis tier — $15.00/M output',
    color: '#4ECDC4',
    icon: '⚡',
  },
  'claude-opus-5': {
    ...
    name: 'Claude Opus 5',
    shortName: 'Opus 5',
    description: 'Frontier deep research & architecture — $75.00/M output',
    color: '#FF6B6B',
    icon: '🧠',
  },
  'claude-haiku-4-5': {
    ...
    shortName: 'Haiku 4.5',
    description: 'Low-latency multimodal model — $4.00/M output',
    color: '#FFE66D',
    icon: '🚀',
  },
  'gemini-3.7-flash': {
    ...
    description: 'Fast multimodal vision & reasoning — $0.60/M output',
    color: '#00BCD4',
    icon: '✨',
  },
  'grok-4.6': {
    ...
    name: 'Grok 4.6',
    shortName: 'Grok 4.6',
    description: 'Strong mathematical & code reasoning — $10.00/M output',
    color: '#E02424',
    icon: '🚀',
  },
  'mimo-v2.5-free': {
  ...
  'llama-4-scout': {
    ...
    description: 'Meta 17B-16E MoE via DeepInfra — $0.30/M output',
    color: '#046A38',
    icon: '🦙',
  },
  'qwen3-235b': {
    ...
    description: 'Alibaba 235B MoE via DeepInfra — $0.10/M output',
    color: '#6C3483',
    icon: '🟣',
  },
  'llama-3.3-70b-turbo': {
    ...
    description: 'Meta 70B via DeepInfra — $0.03/M output',
    color: '#1B4F72',
    icon: '🦙',
  },
  'mistral-small-24b': {
    ...
    description: 'Mistral 24B via DeepInfra — $0.08/M output',
    color: '#E67E22',
    icon: '🌪️',
  },
  'qwen3-32b': {
    ...
    name: 'Qwen3 32B',
    shortName: 'Qwen3 32B',
    description: 'Dense 32B via DeepInfra — $0.28/M output',
    color: '#884EA0',
    icon: '🟣',
  },
  'deepseek-v3': {
    ...
    description: 'DeepSeek 685B MoE via DeepInfra — $0.77/M output',
    color: '#117864',
    icon: '🐋',
  },
  'glm-4.7-flash': {
  ...
  'qwen3.5-4b': {
    ...
    description: 'Ultra-cheap framing challenger — $0.15/M output',
    color: '#5B2C6F',
    icon: '🟣',
  },
  'qwen3.5-9b': {
    ...
    description: 'Cheap structured alternative — $0.20/M output',
    color: '#7D3C98',
    icon: '🟣',
  },
  'step-3.5-flash': {
